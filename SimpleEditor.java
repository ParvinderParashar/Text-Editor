...
public class SimpleEditor extends JFrame implements ActionListener, DocumentListener
{
    ...
    private JMenu fileMenu, editMenu; // Menu references
    private JMenuItem cutItem, copyItem, pasteItem, selectItem;
    private JMenuItem quitItem, openItem  , newitem;    // File items
    ...
    private JMenu formatMenu, textColorMenu;
    ...
    private void initFormatMenu() 
    {
        ...
        mBar.add(formatMenu);            //  and add it to menu bar
    ...
    JMenuItem m  = (JMenuItem)e.getSource();  
        ...
        else if( m == newitem)
        {
          	...
          	final SimpleEditor se = new SimpleEditor();
      	  se.setSize(800, 600);  
            se.setVisible(true);
            se.addWindowListener(new WindowAdapter() {
                   public void windowClosed(WindowEvent e) {se.quitEditor();}
            });
        }
